...
export const billingRules = [
  {
    rulename: "ADD_WATER_BILL_ITEM",
    salience: 50000,
    script: `
    function ADD_WATER_BILL_ITEM(facts,result) { 
      var WC=facts.WaterConsumption;
      ...
      if( facts.WaterConsumption.amount>0.00 && 
          facts.WaterConsumption.hold== false) 
      { 
        result.push({ year: YR,month: MON,amount: AMT,itemid: 'WATER_FEE',itemtitle:'WATER FEE'}); 
        return true; 
      } else { 
        return false; 
      } 
